...
***************************************************************************/
  ...
  $DB->SERVER = "localhost";     // machine database is on
  $DB->NAME = "sample";          // database name
  $DB->LOGIN = "sample";         // database user login
  $DB->PASSWORD = "sample";      // database user password
